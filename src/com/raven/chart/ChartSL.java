...
import com.raven.chart.blankchart.BlankPlotChartSoLuong;
import com.raven.chart.blankchart.BlankPlotChatRender;
import com.raven.chart.blankchart.BlankPlotChatSoLuongRender;
...
public class ChartSL extends javax.swing.JPanel {
    ...
    public ChartSL() {
        initComponents();
        blankPlotChart.setBlankPlotChartSoLuong(new BlankPlotChatSoLuongRender() {
            @Override
            ...
            @Override
            public void renderSeries(BlankPlotChartSoLuong chart, Graphics2D g2, SeriesSize size, int index) {
    ...
    private void initComponents() {
        ...
        blankPlotChart = new com.raven.chart.blankchart.BlankPlotChartSoLuong();
    ...
    private com.raven.chart.blankchart.BlankPlotChartSoLuong blankPlotChart;
