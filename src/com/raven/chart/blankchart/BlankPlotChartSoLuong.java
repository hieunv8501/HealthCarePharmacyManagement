...
public class BlankPlotChartSoLuong extends JComponent {

    public BlankPlotChatSoLuongRender getBlankPlotChatRender() {
        return blankPlotChatRender;
    }

    public void setBlankPlotChartSoLuong(BlankPlotChatSoLuongRender blankPlotChatRender) {
    ...
    private final DecimalFormat format = new DecimalFormat(" #,##0.## Đơn");
    private NiceScale niceScale;
    private double maxValues;
    private double minValues;
    private int labelCount;
    private String valuesFormat = "#,##0.##";
    private BlankPlotChatSoLuongRender blankPlotChatRender;

    public BlankPlotChartSoLuong() {
